  ...
  return (
    <aside className="flex h-screen w-60 flex-col border-r border-gray-200 bg-white">
      ...
      <div className="flex items-center gap-2 px-6 py-5 border-b border-gray-100">
        ...
        <span className="text-base font-semibold text-gray-900">LeaveLedger</span>
      </div>
      ...
      <div className="border-t border-gray-100 p-3">
        ...
        <button
          ...
          className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors mt-0.5"
        >
